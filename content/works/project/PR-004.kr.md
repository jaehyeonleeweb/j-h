...
extra:
  notes:
    - id: "1"
      text: "이 프로젝트에서 사용된 방식<br>수집: 인터넷에서 다운로드<br>추출: 어도비 일러스트레이터의 이미지 트레이스<br>조합: 114 × 164 mm 판형의 기계적 단순 중첩<br>"
  doc_no: "14"
  category: "프로젝트"
  date_sort: "2025-11-02"
  date_year: "2025"
  date_ym: "2025년 11월"
  format: "책, 134 × 190mm, 254p, 디지털 인쇄"
...
[^1]: 이 프로젝트에서 사용된 방식<br>수집: 인터넷에서 다운로드<br>추출: 어도비 일러스트레이터의 이미지 트레이스<br>조합: 114 × 164 mm 판형의 기계적 단순 중첩<br>