...
---
이 책은 [인터넷(주로 핀터레스트와 인스타그램)을 떠돌아다니던](/kr/thought/th-002/) 열두 장의 꽃 사진을 수집해 어도비 CC 일러스트레이터 2025의 [이미지 트레이스](/kr/method/mt-002/)  기능의 도움으로 (약간의 변형을 거쳐) 12개의 꽃 실루엣을 생성해 조합한 그래픽들의 작품집이다.
<br><br>
...
[^1]: 이 프로젝트에서 사용된 방식<br>
	**수집**: 인터넷에서 다운로드<br>
	**추출**: 어도비 CC 일러스트레이터 2025의 이미지 트레이스<br>
